...
from isaaclab_tasks.direct.rrl_mobile_manipulation.cylinder_thruster.cylinder_env_cfg import ThrusterCylinderEnvCfg
...
def main():
    ...
    # create environment
    env = gym.make("RRL-Cylinder-Direct-v0", cfg=env_cfg)
