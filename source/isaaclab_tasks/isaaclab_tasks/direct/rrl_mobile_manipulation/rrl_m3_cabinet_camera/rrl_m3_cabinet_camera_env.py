...
from .rrl_m3_cabinet_camera_env_cfg import M3CabinetCameraEnvCfg  # isort: skip


class M3CabinetCameraEnv(DirectRLEnv):
    ...
    cfg: M3CabinetCameraEnvCfg
    
    def __init__(self, cfg: M3CabinetCameraEnvCfg, render_mode: str | None = None, **kwargs):
